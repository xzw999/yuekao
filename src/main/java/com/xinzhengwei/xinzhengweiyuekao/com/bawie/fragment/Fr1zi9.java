...
public class Fr1zi9 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adap = new Fr1zi9.adapter();
        lv.setAdapter(adap);
        new Fr1zi9.MascyTask().execute(stringurl);
        return view;
    }
    ...
    class adapter extends BaseAdapter {
        ...
        private Fr1zi9.viewHadler viewHadler;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                viewHadler = new Fr1zi9.viewHadler();
                ...
                viewHadler = (Fr1zi9.viewHadler)view.getTag();
            }
