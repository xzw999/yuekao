...
public class Fr1zi7 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adap = new Fr1zi7.adapter();
        lv.setAdapter(adap);
        new Fr1zi7.MascyTask().execute(stringurl);
        return view;
    }
    ...
    class adapter extends BaseAdapter {
        ...
        private Fr1zi7.viewHadler viewHadler1;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                viewHadler1 = new Fr1zi7.viewHadler();
                ...
                viewHadler1 = (Fr1zi7.viewHadler)view.getTag();
            }
