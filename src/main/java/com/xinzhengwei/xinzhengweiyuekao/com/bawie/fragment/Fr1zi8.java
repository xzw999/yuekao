...
import com.xinzhengwei.xinzhengweiyuekao.com.bawie.fragment.com.bawie.bean.Goods2;
...
public class Fr1zi8 extends Fragment{

    private String stringurl="http://www.93.gov.cn/93app/data.do?channelId=0&startNum=3";
    private ListView lv;
    ArrayList<Goods2.DataBean> datalist=new ArrayList<>();
    private ImageLoader instance;
    private Fr1zi8.adapter adap;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adap = new Fr1zi8.adapter();
        lv.setAdapter(adap);
        new Fr1zi8.MascyTask().execute(stringurl);
        return view;
    }
    ...
    private class MascyTask extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Gson gson=new Gson();
            Goods2 goods = gson.fromJson(s, Goods2.class);
            List<Goods2.DataBean> data = goods.getData();
    ...
    class adapter extends BaseAdapter {
        ...
        private Fr1zi8.viewHadler viewHadler1;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                viewHadler1 = new Fr1zi8.viewHadler();
                ...
                viewHadler1 = (Fr1zi8.viewHadler)view.getTag();
            }
