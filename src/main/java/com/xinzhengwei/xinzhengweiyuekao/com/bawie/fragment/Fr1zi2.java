...
public class Fr1zi2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adap = new adapter();
        lv.setAdapter(adap);
        new Fr1zi2.MascyTask().execute(stringurl);
        return view;
    }
    ...
    class adapter extends BaseAdapter {
        ...
        private Fr1zi2.viewHadler viewHadler1;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                ...
                viewHadler1 = (Fr1zi2.viewHadler)view.getTag();
            }
