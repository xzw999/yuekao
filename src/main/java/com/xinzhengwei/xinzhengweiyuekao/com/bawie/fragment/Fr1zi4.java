...
public class Fr1zi4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adap = new Fr1zi4.adapter();
        lv.setAdapter(adap);
        new Fr1zi4.MascyTask().execute(stringurl);
        return view;
    }
    ...
    class adapter extends BaseAdapter {
        ...
        private Fr1zi4.viewHadler viewHadler;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                viewHadler = new Fr1zi4.viewHadler();
                ...
                viewHadler = (Fr1zi4.viewHadler)view.getTag();
            }
